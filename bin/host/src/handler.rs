...
use hokulea_eigenda::{EigenDABlobData, RESERVED_EIGENDA_INTERFACE_BYTE_FOR_RECENCY};
use hokulea_eigenda::{
    BYTES_PER_FIELD_ELEMENT, PAYLOAD_ENCODING_VERSION_0,
    RESERVED_EIGENDA_INTERFACE_BYTE_FOR_VALIDITY, RESERVED_EIGENDA_INTERFACE_BYTE_INDEX,
};
...
pub async fn fetch_eigenda_hint(
    ...
    recency_address[RESERVED_EIGENDA_INTERFACE_BYTE_INDEX] =
    ...
    validity_address[RESERVED_EIGENDA_INTERFACE_BYTE_INDEX] =
