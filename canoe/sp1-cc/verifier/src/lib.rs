...
/// To generate the new ELF (a newer version than 6.0.0 toolchain tag is also fine)
/// ``` bash
/// cd canoe/sp1-cc/client
/// cargo prove build --output-directory ../elf --elf-name canoe-sp1-cc-client --docker --tag v6.0.0
/// ```
///
...
pub const V_KEY: [u32; 8] = [937925827, 281444100, 686019181, 251928259, 81755080, 784757509, 543802571, 1334291389];
    455321262, 1348224488, 972557173, 2049621917, 444605232, 275842489, 871764834, 1118492151,
];
