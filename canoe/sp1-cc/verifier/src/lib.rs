...
/// To generate the new ELF (a newer version than 6.0.0-beta.1 toolchain tag is also fine)
/// ``` bash
/// cd canoe/sp1-cc/client
/// cargo prove build --output-directory ../elf --elf-name canoe-sp1-cc-client --docker --tag v6.0.0-beta.1
/// ```
///
...
pub const V_KEY: [u32; 8] = [
    1551041839, 1839237331, 491722694, 687013237, 1459570853, 245726699, 1582538134, 290324109,
];
